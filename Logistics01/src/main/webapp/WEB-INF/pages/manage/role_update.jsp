    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <button class="layui-btn" onclick="formSubmit('role_update','_self');this.blur();">保存并返回</button>
                    </ul>
                </div>
            </div>
        </div>
     ...
     <div class="layui-field-box">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="roleId"  value="${role.roleId}"  class="layui-input"  readonly="readonly">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="remarks" value="${role.remarks}" class="layui-input">
                </div>
            </div>
        </div>

    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <button class="layui-btn" onclick="formSubmit('distribute_trucks','_self');this.blur();">分配货车</button>
                        <button class="layui-btn" onclick="formSubmit('send_out','_self');this.blur();">发货</button>
                        <button class="layui-btn" onclick="formSubmit('arrive','_self');this.blur();">到货</button>
                        <button class="layui-btn" onclick="formSubmit('stop','_self');this.blur();">禁用</button>
                    </ul>
                </div>
            </div>
        </div>
